...
* **litex/soc/cores/cpu/cyclonev_hps**             : Added Intel Cyclone V HPS (hard dual Cortex-A9) hardcore CPU support with H2F-LW/H2F AXI3 masters, F2H AXI3 slave and F2H interrupts through direct `cyclonev_hps_interface_*` atom instantiation (no Qsys), targeting boards where the HPS is pre-booted (e.g. MiSTer/DE10-Nano).
